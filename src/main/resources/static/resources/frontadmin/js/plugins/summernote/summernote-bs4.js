...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        shortcut: {
            shortcuts: 'Keytbboard shortcuts',
            close: 'Close',
...
var Cliptbboard = /** @class */ (function () {
    function Cliptbboard(context) {
        this.context = context;
        this.$editable = context.layoutInfo.editable;
    }
    Cliptbboard.prototype.initialize = function () {
        this.$editable.on('paste', this.pasteByEvent.bind(this));
    };
    /**
     * paste by cliptbboard event
     *
     * @param {Event} event
     */
    Cliptbboard.prototype.pasteByEvent = function (event) {
        var cliptbboardData = event.originalEvent.cliptbboardData;
        if (cliptbboardData && cliptbboardData.items && cliptbboardData.items.length) {
            var item = lists.head(cliptbboardData.items);
